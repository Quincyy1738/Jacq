          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('lib/assets/flavorscreen.jpg'), // Replace with your image path
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      onPressed: () => Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => Hpd2()),
                      ),
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 5,
                        backgroundColor: Colors.lightGreen, // Set button color to yellow
                      ),
