...
class SinigangNaBakaPage extends StatelessWidget {
  @override
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Positioned.fill(
                    child: Image.asset(
                      'lib/assets/sinigang na baka.jpg', // Replace with your image path
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
              ...
              Text(
                'Sinigang na Baka is a Filipino sour soup made with beef, vegetables, and tamarind broth. It is a popular comfort food in the Philippines, often enjoyed during cold weather or as a hearty meal any time of the year. This Sinigang na Baka recipe is easy to make and bursting with tangy and savory flavors. Serve it hot with steamed rice for a delicious and satisfying meal!\n',
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('• 1 lb beef shank or beef ribs, cut into serving pieces'),
              ...
              Column(
                ...
                children: [
                  Text(
                    '1. In a large pot, bring water to a boil. Add the beef, onion, and tomatoes. Simmer for 40-50 minutes or until the beef is tender.\n',
                  ),
                  Text(
                  ...
                  Text(
                    '6. Remove from heat and serve hot. Enjoy your delicious Sinigang na Baka!\n',
                  ),
                ],
              ),
            ],
